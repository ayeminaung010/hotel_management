                            ...
                            <div class="d-flex  justify-content-between">
                                <div class="filters m-b-45">
                                    <div class="rs-select2--dark rs-select2--md m-r-10 rs-select2--border">
                                        <select class="form-select js-select2" id="workTimeSort" >
                                            @foreach ($workTimes as $workTime )
                                                <option value="{{ $workTime->id }}"  >{{ $workTime->working_date }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="">
                                    <input type="text" class="" id="searchData" placeholder="Search...">
                                </div>
                            </div>
