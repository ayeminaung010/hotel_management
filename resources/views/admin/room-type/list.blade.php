                    ...
                    <div class="col-xl-12">
                        ...
                        <div class="user-data m-b-40">
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="">
                                    <input type="text" class="" id="room_type_search" placeholder="Search...">
                                </div>
                            </div>
                                        ...
                                        <div class="modal fade" id="detail{{ $roomType->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                              <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="mb-3">
                                                        <label for="" class="col-form-label">Room Name</label>
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="" class="col-form-label">Price Per Night</label>
                                                        <input type="text" class="form-control" value="{{ $roomType->price_per_night  }}"  disabled>
                                                    </div>
